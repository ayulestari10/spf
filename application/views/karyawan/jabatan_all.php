                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                                                                ...
                                                                                <a href="<?= base_url('karyawan/detail_jabatan/'.$row['id_jabatan']) ?>" class="btn btn-info waves-effect">Details</a>
...
<script type="text/javascript">
        ...
        function delete_jabatan(id_jabatan) {
            $.ajax({
                ...
                success: function() {
                    window.location = "<?= base_url('karyawan/Jabatan') ?>";
                }
            });   
        }
        </script>