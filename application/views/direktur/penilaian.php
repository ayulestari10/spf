                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php else: ?>
                                            <td align="center">
                                                <a href="<?= base_url(($id_jabatan == 2 ? 'manajer' : ($id_jabatan == 3 ? 'direktur' : 'karyawan')) . '/detail-nilai?id_penilaian=' . $id_penilaian . '&id_karyawan=' . $row->id_karyawan) ?>" class="btn btn-primary btn-sm waves-effect"><i class="fa fa-eye"></i> Lihat nilai</a>
                                            </td>
                                        <?php endif; ?>
                                    </tr>
                                    <?php endforeach; ?>
...
<script type="text/javascript">
        ...
        function acc_penilaian(id_karyawan) {
            $.ajax({
                url: '<?= base_url((($id_jabatan == 2) ? 'manajer' : ($id_jabatan == 3 ? 'direktur' : 'karyawan')) . '/penilaian-detail?id_penilaian=' . $id_penilaian) ?>',
                type: 'POST',
                data: {
                    validasi: true,
