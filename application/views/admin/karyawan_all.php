                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                                                                ...
                                                                                <a href="<?= base_url('admin/detail_karyawan/'.$row['id_karyawan']) ?>" class="btn btn-info waves-effect">Details</a>
...
<script type="text/javascript">
        ...
        function delete_karyawan(id_karyawan) {
            $.ajax({
                ...
                success: function() {
                    window.location = "<?= base_url('admin/Karyawan') ?>";
                }
            });   
        }
        </script>