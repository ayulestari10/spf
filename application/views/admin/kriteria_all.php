                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Data  Kriteria                                                             <button type="button" class="btn btn-default" data-toggle="modal" data-target="#add"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
                                                    </div>
                        <!-- /.panel-heading -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                                                                ...
                                                                                <a href="<?= base_url('admin/detail_kriteria/'.$row['id_kriteria']) ?>" class="btn btn-info waves-effect">Details</a>
                                        
                                                                                <button class="btn btn-info waves-effect" data-toggle="modal" data-target="#edit" onclick="get_kriteria(<?= $row['id_kriteria'] ?>)"><i class="glyphicon glyphicon-pencil"></i></button>
                                        
                                                                                <button class="btn btn-danger waves-effect" onclick="delete_kriteria(<?= $row['id_kriteria'] ?>)"><i class="glyphicon glyphicon-trash"></i> </button>
